...
var (
	...
	AdversaryTypes          = []int{0, 0, 0} // Defines attack strategy, one of the following: 0 - honest node behavior, 1 - shifts opinion, 2 - keeps the same opinion. Max 3 types, one per color. SimulationTarget must be 'DS'
