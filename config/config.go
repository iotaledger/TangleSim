...
var (
	...
	AdversaryDelays         = []int{50, 50}     // Delays in ms of adversary nodes, eg '50 100 200', SimulationTarget must be 'DS'
	...
	AdversaryMana           = []float64{17, 17} // Adversary nodes mana in %, e.g. '10 10' or leave empty if adversary nodes should be selected randomly, 0 means low mana node, 100 means high mana node. SimulationTarget must be 'DS'
