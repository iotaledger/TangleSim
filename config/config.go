...
var (
	...
	GodMana      = 15               // Defines percentage of mana the adversary holds
	GodDelay     = time.Duration(1) // Defines the delay after which adversary is allowed to react to switch opinion
	GodNodeSplit = 1                // Define on how many nodes should split the God Node, God Nodes are not included in config.NodesCount
)
